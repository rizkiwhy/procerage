<template>
  ...
  <v-container>
    ...
    >
      ...
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Bidang</v-toolbar-title>
...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
      axios
        .delete(`${this.url}/fields/${this.editedItem._id}`, {
          headers: {
            Authorization: token,
          },
        })
    ...
    save() {
      ...
      //   }
        ...
        axios
          .put(`${this.url}/fields/${this.editedItem._id}`, this.editedItem, {
            headers: {
              Authorization: token,
            },
          })
        ...
        axios
          .post(`${this.url}/fields`, this.editedItem, {
            headers: {
              Authorization: token,
            },
          })
