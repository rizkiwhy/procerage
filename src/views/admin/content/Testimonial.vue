                ...
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="12">
                      <v-textarea
                        rows=3
                        v-model="editedItem.testimonial"
                        label="Testimonial"
                      ></v-textarea>
                    </v-col>
...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
      axios
        .delete(`${this.url}/testimonials/${this.editedItem._id}`, {
          headers: {
            Authorization: token,
          },
        })
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        formData.append('testimonial', this.editedItem.testimonial)
        ...
        axios
          .put(`${this.url}/testimonials/${this.editedItem._id}`, formData, {
            headers: {
        ...
        axios
          .post(`${this.url}/testimonials`, formData, {
            headers: {
              'content-type': 'multipart/form-data',
              Authorization: token,
            },
